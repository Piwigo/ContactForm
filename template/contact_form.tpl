...
{if $themeconf.name == "stripped" or $themeconf.parent == "stripped"}
  {include file=$CONTACT_FORM_ABS_PATH|@cat:'template/themes/stripped.tpl'}
  {assign var="clear" value="true"}
{elseif $themeconf.name == "simple-grey" or $themeconf.parent == "simple"}
  {include file=$CONTACT_FORM_ABS_PATH|@cat:'template/themes/simple.tpl'}
  {assign var="clear" value="true"}
{else}
  {include file=$CONTACT_FORM_ABS_PATH|@cat:'template/themes/default.tpl'}
{/if}
